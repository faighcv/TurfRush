...
export const usersApi = {
  ...
  updateProfile: (data: { bio?: string; avatar_color?: string }) =>
...
export const territoryApi = {
  ...
  mine: () => api.get('/territory/mine').then(r => r.data),
};
...
export const socialApi = {
  ...
  acceptRequest: (friendshipId: string) => api.post(`/social/friends/${friendshipId}/accept`).then(r => r.data),
